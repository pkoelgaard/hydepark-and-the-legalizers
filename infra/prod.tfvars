...
# AMI currently used by the production EC2 instance.
# Keep this pinned so Terraform does not replace the production server
# when Amazon publishes a newer Amazon Linux AMI.
ami_id = "ami-01d5faff4584de9de"
